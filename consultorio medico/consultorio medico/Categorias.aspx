<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Categorias.aspx.cs" Inherits="consultorio_medico.Categorias" %>
                    ...
                    <div class="card-body">
                        <div class="form-contenedor">
                            <div class="mb-3">
                                ...
                                <asp:TextBox runat="server" type="text" class="form-control" id="txtAgregarCat" placeholder="Nombre de categoria"/>
                            </div>

                            <asp:Button Text="Agregar" ID="btnAgregar" runat="server" OnClick="btnAgregar_Click" CssClass="btn-custom btn-success-custom" />
            ...
            <ContentTemplate>
                <div class="card-custom">
                    ...
                    <div class="card-body">
                        <div class="form-contenedor">
                            <div class="mb-3">
                                <label for="ddlMarcape" class="form-label">Categoria</label>
                                <asp:DropDownList runat="server" ID="ddlCategoriape" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                            ...
                            <asp:Button Text="Modificar" ID="btnEditar" runat="server" OnClick="btnEditar_Click" CssClass="btn-custom btn-warning-custom" 
                                OnClientClick="return confirm('¿Estás seguro de que deseas modificar esta marca?');" />
                            <asp:Button Text="Eliminar" ID="btnEliminar" runat="server" OnClick="btnEliminar_Click" CssClass="btn-custom btn-danger-custom" 
